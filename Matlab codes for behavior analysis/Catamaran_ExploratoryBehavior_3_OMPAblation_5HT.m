function Catamaran_ExploratoryBehavior_3_OMPAblation_5HT
...
DATA_OMPAblation_5HT = struct('Trial_ID', [], 'Fish_ID', [], 'Treatment', [], 'Condition', [], 'Outlier', [], 'Swim_t0', [], 'Swim_t10', [], 'FQ_t0', [], 'FQ_t10', [], 'Speed_t0', [], 'Speed_t10', [], 'Turns_t0', [], 'Turns_t10', []);
...
ID_OMPAblation_E3 = unique([datasetPerFish_ID([datasetPerFish_ID.Condition] == 1 & [datasetPerFish_ID.Genotype] == 1).Fish_ID]);
ID_OMPAblation_E3(2,:) = deal(1); ID_OMPAblation_E3(3,:) = deal(2);
ID_OMPAblation_5HT = unique([datasetPerFish_ID([datasetPerFish_ID.Condition] == 2 & [datasetPerFish_ID.Genotype] == 1).Fish_ID]);
ID_OMPAblation_5HT(2,:) = deal(2); ID_OMPAblation_5HT(3,:) = deal(2);
ID_all = [ID_CT_E3 ID_CT_5HT ID_OMPAblation_E3 ID_OMPAblation_5HT];
...
for f = 1:N(1,1)
    DATA_OMPAblation_5HT(f,1).Trial_ID = datasetPerFish_ID([datasetPerFish_ID.Fish_ID] == ID_all(1,f) & [datasetPerFish_ID.Condition] == ID_all(2,f)).Trial_ID;
    DATA_OMPAblation_5HT(f,1).Fish_ID = ID_all(1,f);
    DATA_OMPAblation_5HT(f,1).Outlier = Outliers(ID_all(1,f),1);
    if ID_all(2,f) == 1 && ID_all(3,f) == 1
        DATA_OMPAblation_5HT(f,1).Condition = 'E3';
        DATA_OMPAblation_5HT(f,1).Treatment = 'Control';
        j0 = 1;
        j10 = 3;
    elseif ID_all(2,f) == 1 && ID_all(3,f) == 2 
        DATA_OMPAblation_5HT(f,1).Condition = 'E3';
        DATA_OMPAblation_5HT(f,1).Treatment = 'OMP ablation';
        j0 = 2;
        j10 = 4;
    elseif ID_all(2,f) == 2 && ID_all(3,f) == 1 
        DATA_OMPAblation_5HT(f,1).Condition = '5-HT';
        DATA_OMPAblation_5HT(f,1).Treatment = 'Control';
        j0 = 1;
        j10 = 5;
    ...
    DATA_OMPAblation_5HT(f,1).Swim_t0 = pSwim(ID_all(1,f),j0);
    DATA_OMPAblation_5HT(f,1).FQ_t0 = 1000/MedianIBI(ID_all(1,f),j0);  
    DATA_OMPAblation_5HT(f,1).Speed_t0 = MedianSpeed(ID_all(1,f),j0);
    DATA_OMPAblation_5HT(f,1).Turns_t0 = pTurns(ID_all(1,f),j0);
    DATA_OMPAblation_5HT(f,1).Swim_t10 = pSwim(ID_all(1,f),j10);
    DATA_OMPAblation_5HT(f,1).FQ_t10 = 1000/MedianIBI(ID_all(1,f),j10);  
    DATA_OMPAblation_5HT(f,1).Speed_t10 = MedianSpeed(ID_all(1,f),j10);
    DATA_OMPAblation_5HT(f,1).Turns_t10 = pTurns(ID_all(1,f),j10);
...
subplot(2,2,1)
    ...
    xticklabels({'CT', 'CT+5HT', 'OMPAblation', 'OMPAblation+5HT'}); set(gca, 'xticklabelrotation', 45);
    ...
    % stat to see the effect of 5-HT on BAPTA-treated larvae
        ...
        if p > 0.05
            ...
            [h,a,c,s] = aoctool(y0, y10, x);
            if cell2mat(a(4,6)) > 0.05
                pSwim_OMPAblation = cell2mat(a(2,6));
                aSwim_OMPAblation = a;
                sigstar_LFD([5.5 7.5], pSwim_OMPAblation);
            else
                pSwim_OMPAblation = NaN; aSwim_OMPAblation = NaN;
                uiwait(msgbox('Non homogenous regression!'));
            end
        else
            pSwim_OMPAblation = NaN; aSwim_OMPAblation = NaN;
...
subplot(2,2,2)
    ...
    % stat to see the effect of 5-HT on BAPTA-treated larvae
        ...
        if p > 0.05
            ...
            [h,a,c,s] = aoctool(y0, y10, x);
            if cell2mat(a(4,6)) > 0.05
                pFQ_OMPAblation = cell2mat(a(2,6));
                aFQ_OMPAblation = a;
                sigstar_LFD([5.5 7.5], pFQ_OMPAblation);
            else
                pFQ_OMPAblation = NaN; aFQ_OMPAblation = NaN;
                uiwait(msgbox('Non homogenous regression!'));
            end
        else
            pFQ_OMPAblation = NaN; aFQ_OMPAblation = NaN;
...
subplot(2,2,3)
    ...
    % stat to see the effect of 5-HT on BAPTA-treated larvae
        ...
        if p > 0.05
            ...
            [h,a,c,s] = aoctool(y0, y10, x);
            if cell2mat(a(4,6)) > 0.05
                pSpeed_OMPAblation = cell2mat(a(2,6));
                aSpeed_OMPAblation = a;
                sigstar_LFD([5.5 7.5], pSpeed_OMPAblation);
            else
                pSpeed_OMPAblation = NaN; aSpeed_OMPAblation = NaN;
                uiwait(msgbox('Non homogenous regression!'));
            end
        else
            pSpeed_OMPAblation = NaN; aSpeed_OMPAblation = NaN;
...
subplot(2,2,4)
    ...
    % stat to see the effect of 5-HT on BAPTA-treated larvae
        ...
        if p > 0.05
            ...
            [h,a,c,s] = aoctool(y0, y10, x);
            if cell2mat(a(4,6)) > 0.05
                pTurns_OMPAblation = cell2mat(a(2,6));
                aTurns_OMPAblation = a;
                sigstar_LFD([5.5 7.5], pTurns_OMPAblation);
            else
                pTurns_OMPAblation = NaN; aTurns_OMPAblation = NaN;
                uiwait(msgbox('Non homogenous regression!'));
            end
        else
            pTurns_BAPTA = NaN; aTurns_OMPAblation = NaN;
            uiwait(msgbox('The baseline between the 2 groups is significantly different'));    
        end
saveas(h1, '220405 - Effect of 5-HT on control of OMP ablated larvae (234h, without outliers #83,119).fig');
set(gcf,'renderer','Painters');
print -depsc -tiff -r300 -painters Image.eps
P_ANCOVA_t0_versus_t10 = [pSwim_CT, pSwim_OMPAblation, pFQ_CT, pFQ_OMPAblation, pSpeed_CT, pSpeed_OMPAblation, pTurns_CT, pTurns_OMPAblation];

%% 4. plot effect of 5HT on OMP-ablated larvae only 
...
P_MW_OMP_E3_versus_5HT = [pSwim_5HT, pFQ_5HT, pSpeed_5HT, pTurns_5HT];
saveas(h2, '220405 - Effect of 5-HT on OMP-ablated larvae (234h, without outliers #83,119).fig');
set(gcf,'renderer','Painters');
print -depsc -tiff -r300 -painters Image.eps
...
save(['220405 - Effect of 5-HT on OMPAblated larvae (234h, without outliers #83,119).mat'], 'DATA_OMPAblation_5HT', 'ID_all', 'Swim', 'FQ', 'Speed', 'Turns', 'Nf', 'P_MW_OMP_E3_versus_5HT');
% 'P_ANCOVA_t0_versus_t10', 